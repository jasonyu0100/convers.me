...
export function LandingPage() {
  ...
  const features = {
    ...
    schedule: {
      ...
      description:
        'Generate your perfect week from a single prompt, with intelligent scheduling that simplifies complex workflows and turns your intentions into structured time blocks with automated browser actions.',
      points: ['Single-prompt weekly planning', 'Dynamic workload adaptation', 'Automated browser task execution'],
    },
    journal: {
      title: 'Time-Boxed Execution',
      description:
        'Navigate your week with a Google Maps-like experience, completing process steps and capturing insights within each time-boxed event while automating repetitive browser tasks.',
      points: ['In-event process guidance', 'Real-time browser automation', 'Integrated journaling and documentation'],
    },
    track: {
      title: 'Performance Insights',
      description:
        'Continuously improve your processes with AI-powered analytics that track adherence, identify bottlenecks, and surface actionable insights on automated browser workflows.',
      points: ['Process adherence metrics', 'Browser automation efficiency tracking', 'Continuous improvement suggestions'],
    },
  };
  ...
  return (
    <div className='relative min-h-screen w-full overflow-x-hidden pt-20'>
      ...
      <div className='fixed left-0 right-0 top-2 z-50 flex w-full justify-center px-2 md:top-4 md:px-0'>
      ...
      <section className='relative z-10 flex min-h-[90vh] flex-col items-center justify-center px-4 text-center'>
        ...
        <div className='pointer-events-none absolute inset-0'>
          <div className='absolute left-1/4 top-1/4 h-2 w-2 animate-pulse rounded-full bg-blue-200 shadow-lg shadow-blue-200/50'></div>
          <div className='absolute right-1/3 top-1/3 h-3 w-3 animate-pulse rounded-full bg-purple-200 shadow-lg shadow-purple-200/50 delay-700'></div>
          <div className='absolute bottom-1/4 right-1/4 h-2 w-2 animate-pulse rounded-full bg-blue-200 shadow-lg shadow-blue-200/50 delay-1000'></div>
        </div>

        <div className='mx-auto max-w-3xl'>
          {/* Main Heading - More Expressive */}
          <h1 className='mb-8 text-5xl font-extrabold leading-tight tracking-tight text-blue-700 sm:text-6xl md:text-7xl lg:text-8xl'>
            <span className='bg-gradient-to-r from-blue-400 via-purple-600 to-blue-600 bg-clip-text text-transparent'>Intelligent</span>{' '}
            <span className='bg-gradient-to-br from-blue-500 to-blue-700 bg-clip-text text-transparent'>Browser Agent</span>
          </h1>
        ...
        <div className='mx-auto mt-16 grid max-w-4xl grid-cols-1 gap-4 sm:grid-cols-3'>
          <div className='flex flex-col items-center rounded-xl bg-white/60 p-5 shadow-md backdrop-blur-sm transition-all hover:bg-white/70 hover:shadow-lg'>
            <div className='mb-2 font-bold text-3xl text-blue-700'>85%</div>
            <p className='text-center font-medium text-sm text-blue-600'>Reduction in Manual Browser Tasks</p>
          </div>
          <div className='flex flex-col items-center rounded-xl bg-white/60 p-5 shadow-md backdrop-blur-sm transition-all hover:bg-white/70 hover:shadow-lg'>
            <div className='mb-2 font-bold text-3xl text-blue-700'>6.2x</div>
            <p className='text-center font-medium text-sm text-blue-600'>Faster Browser Workflow Execution</p>
          </div>
          <div className='flex flex-col items-center rounded-xl bg-white/60 p-5 shadow-md backdrop-blur-sm transition-all hover:bg-white/70 hover:shadow-lg'>
            <div className='mb-2 font-bold text-3xl text-blue-700'>98%</div>
            <p className='text-center font-medium text-sm text-blue-600'>Browser Automation Accuracy</p>
          </div>
        </div>
      </section>
              ...
              <div className='w-full md:w-1/2'>
                ...
                <ul className='space-y-3'>
                  <li className='flex'>
                    ...
                    <span className='font-medium text-blue-800'>AI matches your goals to browser automations</span>
                  </li>
                  <li className='flex'>
                    <div className='mr-3 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-emerald-500'>
                      <svg className='h-3 w-3 text-white' fill='currentColor' viewBox='0 0 20 20'>
                    ...
                    <span className='font-medium text-blue-800'>Understands natural language commands</span>
                  </li>
                  <li className='flex'>
                    <div className='mr-3 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-emerald-500'>
                      <svg className='h-3 w-3 text-white' fill='currentColor' viewBox='0 0 20 20'>
                    ...
                    <span className='font-medium text-blue-800'>Creates reusable browser automations</span>
                  </li>
                </ul>
              </div>
              ...
              <div className='w-full md:w-1/2'>
                ...
                <div className='rounded-xl border border-white/20 bg-white/80 p-8 backdrop-blur-sm'>
                  <div className='mb-6 rounded-xl border border-blue-100/50 bg-gradient-to-r from-blue-50 to-indigo-50 p-5'>
                    <p className='text-md italic text-slate-700'>
                  ...
                  <button className='w-full rounded-lg bg-blue-500 px-6 py-3 font-medium text-sm text-white transition-colors hover:bg-blue-600'>
            ...
            <div className='flex flex-col items-center md:flex-row md:gap-16'>
              <div className='w-full md:w-1/2'>
                <div className='mb-4 flex items-center'>
                  ...
                  <h3 className='font-bold text-2xl text-blue-700'>AI-Generated Schedule</h3>
                </div>
                <p className='mb-6 font-light text-lg text-blue-600'>
                  ...
                  <div className='space-y-4'>
                      ...
                      <div className='flex-1'>
                        <div className='rounded-lg border border-slate-100 bg-white/80 p-4 shadow-sm transition-all hover:shadow-md'>
                          <div className='mb-2 flex items-center'>
                            <span className='font-medium text-sm text-slate-700'>Monday, April 23</span>
                            <span className='ml-auto rounded-full bg-emerald-100 px-2 py-0.5 font-medium text-xs text-emerald-700'>Completed</span>
                          </div>
                          <div className='flex items-center rounded-md border-l-4 border-blue-400 bg-slate-50 p-2.5'>
                            <div className='flex-1'>
                              <div className='flex items-center justify-between'>
                                <span className='font-medium text-sm text-slate-700'>Client Onboarding - Acme Inc.</span>
                    ...
                    <div className='flex'>
                      ...
                      <div className='flex-1'>
                        <div className='rounded-lg border border-slate-100 bg-white/80 p-4 shadow-sm transition-all hover:shadow-md'>
                          <div className='mb-2 flex items-center'>
                            <span className='font-medium text-sm text-slate-700'>Tuesday, April 24</span>
                            <span className='ml-auto rounded-full bg-emerald-100 px-2 py-0.5 font-medium text-xs text-emerald-700'>Completed</span>
                          </div>
                          <div className='flex items-center rounded-md border-l-4 border-blue-400 bg-slate-50 p-2.5'>
                            <div className='flex-1'>
                              <div className='flex items-center justify-between'>
                                <span className='font-medium text-sm text-slate-700'>Client Training - TechCorp</span>
                    ...
                    <div className='flex'>
                      <div className='mr-4 flex flex-col items-center'>
                        <div className='flex h-8 w-8 items-center justify-center rounded-full bg-blue-500 text-white ring-4 ring-blue-100'>
                          <span className='font-medium text-xs'>W</span>
                        </div>
                      ...
                      <div className='flex-1'>
                        <div className='rounded-lg border-2 border-blue-300 bg-white/80 p-4 shadow-md'>
                          <div className='mb-2 flex items-center'>
                            <span className='font-medium text-sm text-blue-700'>Wednesday, April 25</span>
                            <span className='ml-auto rounded-full bg-amber-100 px-2.5 py-0.5 font-medium text-xs text-amber-700'>
                          ...
                          <div className='space-y-2'>
                            <div className='flex items-center rounded-md border border-l-4 border-slate-100 border-l-emerald-400 bg-white/80 p-3'>
                              <div className='flex-1'>
                                <div className='flex items-center justify-between'>
                                  <span className='font-medium text-sm text-slate-700'>Support Ticket Resolution</span>
                            ...
                            <div className='flex items-center rounded-md border border-l-4 border-blue-200 border-l-blue-500 bg-blue-50 p-3'>
                              ...
                              <div className='flex-1'>
                                <div className='flex items-center justify-between'>
                                  <span className='font-medium text-sm text-blue-700'>Client Onboarding - GlobalTech</span>
                    ...
                    <div className='flex'>
                      ...
                      <div className='flex-1'>
                        <div className='rounded-lg border border-slate-100 bg-white/80 p-4 opacity-80 shadow-sm'>
                          <div className='mb-2 flex items-center'>
                            <span className='font-medium text-sm text-slate-700'>Thu-Fri, Apr 26-27</span>
                            <span className='ml-auto rounded-full bg-slate-100 px-2 py-0.5 font-medium text-xs text-slate-700'>Upcoming</span>
                          </div>
                          <div className='space-y-2'>
                            <div className='flex items-center rounded-md border-l-4 border-purple-400 bg-slate-50 p-2.5'>
                              <div className='flex-1'>
                                <div className='flex items-center justify-between'>
                                  <span className='font-medium text-sm text-slate-700'>Client Requirements Documentation</span>
                            ...
                            <div className='flex items-center rounded-md border-l-4 border-blue-400 bg-slate-50 p-2.5'>
                              <div className='flex-1'>
                                <div className='flex items-center justify-between'>
                                  <span className='font-medium text-sm text-slate-700'>Customer Success Handoff Meeting</span>
            ...
            <div className='flex flex-col items-center gap-12 md:flex-row md:gap-16'>
              <div className='w-full md:w-1/2'>
                <div className='mb-4 flex items-center'>
                  ...
                  <h3 className='font-bold text-2xl text-blue-700'>Step-by-Step Execution</h3>
                </div>
                <p className='mb-6 font-light text-lg text-blue-600'>
      ...
      <section className='relative z-10 bg-gradient-to-b from-white to-blue-50 py-12 md:py-24'>
        <div className='mx-auto max-w-6xl px-3 md:px-8'>
          <h2 className='mb-4 text-center font-bold text-3xl text-blue-700 md:text-4xl'>Pilot your Week</h2>
          ...
          <div className='relative mb-12 overflow-hidden rounded-xl bg-white p-4 shadow-lg md:p-8'>
            {/* Decorative elements */}
            <div className='absolute right-0 top-0 h-32 w-32 -translate-y-1/2 translate-x-1/2 rounded-full bg-blue-50 opacity-50'></div>
              ...
              <div className='flex flex-col overflow-hidden rounded-lg border border-slate-100 bg-gradient-to-br from-slate-50 to-white shadow-sm transition-all hover:shadow-md'>
                <div className='border-b border-slate-100 bg-slate-50/50 p-3'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='rounded-full bg-green-100 px-2 py-0.5 font-medium text-xs text-green-700'>80%</span>
                  </div>
                </div>
                <div className='p-3'>
                  <div className='space-y-2'>
                    <div className='flex items-center space-x-2'>
                      ...
                      <span className='truncate text-xs text-slate-600'>CRM Data Entry Automation</span>
                    </div>
                    <div className='flex items-center space-x-2'>
                      <div className='h-3 w-3 rounded-full bg-green-500'></div>
                      <span className='truncate text-xs text-slate-600'>Automated Form Submission</span>
                    </div>
                    <div className='flex items-center space-x-2'>
                      <div className='h-3 w-3 rounded-full bg-orange-500'></div>
                      <span className='truncate text-xs text-slate-600'>Data Scraping Task</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='flex flex-col overflow-hidden rounded-lg border border-slate-100 bg-gradient-to-br from-slate-50 to-white shadow-sm transition-all hover:shadow-md'>
                <div className='border-b border-slate-100 bg-slate-50/50 p-3'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='rounded-full bg-green-100 px-2 py-0.5 font-medium text-xs text-green-700'>90%</span>
                  </div>
                </div>
                <div className='p-3'>
                  <div className='space-y-2'>
              ...
              <div className='flex transform flex-col overflow-hidden rounded-lg border border-blue-200 bg-gradient-to-br from-blue-50 to-white shadow-md transition-all hover:shadow-lg'>
                <div className='border-b border-blue-100 bg-blue-50 p-3'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='rounded-full bg-blue-100 px-2 py-0.5 font-medium text-xs text-blue-700'>50%</span>
                  </div>
                </div>
                <div className='p-3'>
                  <div className='space-y-2'>
              ...
              <div className='flex flex-col overflow-hidden rounded-lg border border-slate-100 bg-gradient-to-br from-slate-50 to-white shadow-sm transition-all hover:shadow-md'>
                <div className='border-b border-slate-100 bg-slate-50/50 p-3'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='rounded-full bg-orange-100 px-2 py-0.5 font-medium text-xs text-orange-700'>25%</span>
                  </div>
                </div>
                <div className='p-3'>
                  <div className='space-y-2'>
              ...
              <div className='flex flex-col overflow-hidden rounded-lg border border-slate-100 bg-gradient-to-br from-slate-50 to-white shadow-sm transition-all hover:shadow-md'>
                <div className='border-b border-slate-100 bg-slate-50/50 p-3'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='rounded-full bg-slate-100 px-2 py-0.5 font-medium text-xs text-slate-700'>10%</span>
                  </div>
                </div>
                <div className='p-3'>
                  <div className='space-y-2'>
      ...
      <section className='relative z-10 overflow-hidden bg-gradient-to-r from-blue-600 to-purple-700 py-20 text-white'>
        ...
        <div className='absolute inset-0 opacity-20'>
          <div className='absolute left-10 top-10 h-[30vh] w-[30vw] rounded-full bg-white/80 blur-3xl'></div>
          <div className='absolute bottom-0 right-10 h-[20vh] w-[20vh] rounded-full bg-white/80 blur-3xl'></div>
          <div className='absolute bottom-1/3 right-1/4 h-[25vh] w-[25vw] rounded-full bg-purple-300 opacity-40 blur-3xl'></div>
        </div>

        <div className='relative z-10 mx-auto max-w-4xl px-4 text-center md:px-8'>
          <h2 className='mb-5 font-bold text-3xl md:text-4xl lg:text-5xl'>
            <span className='bg-gradient-to-r from-blue-200 to-white bg-clip-text text-transparent'>Automate Browser Tasks</span>
          </h2>
          <p className='mb-10 text-lg opacity-90 md:text-xl lg:text-2xl'>
            <span className='bg-gradient-to-r from-blue-200 via-purple-200 to-blue-200 bg-clip-text font-bold text-transparent'>
              Eliminate repetitive tasks
            </span>
            , <span className='bg-gradient-to-r from-purple-200 to-white bg-clip-text font-bold text-transparent'>boost productivity</span>, and{' '}
            <span className='bg-gradient-to-br from-white to-blue-200 bg-clip-text font-bold text-transparent'>streamline workflows</span>
          </p>
        ...
        <div className='mx-auto max-w-4xl'>
          <div className='mb-6 flex flex-col items-center justify-between gap-6 md:flex-row'>
            <div className='flex flex-col items-center md:items-start'>
              ...
              <p className='text-center text-xs text-white/80 md:text-left'>
                AI-powered browser automation that transforms repetitive tasks into efficient workflows
              </p>
            </div>
          </div>
