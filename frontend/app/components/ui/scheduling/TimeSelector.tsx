...
import { AvailabilitySlot } from './Calendar';
...
/**
 * A reusable time selector component for selecting available time slots
 */
export function TimeSelector({ selectedDate, selectedTime, onTimeSelect, availabilityData }: TimeSelectorProps) {
